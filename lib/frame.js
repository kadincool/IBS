...
export async function draw() {
  ...
  can2d.fillRect(camera.x-10, camera.y+10, player.stats.maxHealth/4, 1);
  can2d.fillStyle = "red";
  can2d.fillRect(camera.x-10, camera.y+10, player.stats.health/4, 1);
  can2d.fillStyle = "green";
  can2d.fillRect(camera.x-10, camera.y+9, player.stats.maxEnergy/4, 1);
  can2d.fillStyle = "lime";
  can2d.fillRect(camera.x-10, camera.y+9, player.stats.energy/4, 1);
}